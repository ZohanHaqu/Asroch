...
def searchFilesOnWebsite(command):
    ...
    try:
        ...
        files = ["file1.zip", "file2.tar", "file3.exe"]
...
def shell():
    ...
    print("VISO SHELL 1.1")
    print("Copyright (C) Zohan Haque. All rights reserved.")
    print("\nFor more help, visit the help page: please view VISO Shells YouTube Channel")
...
Available Commands:
    ...
    convert "file.any" to ".format" - Simulates converting a file to a new format.
    ...
    search <https://example.com> - Searches files on a website.
